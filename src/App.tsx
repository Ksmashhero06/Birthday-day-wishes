...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-between overflow-x-hidden selection:bg-pastel-rose-light selection:text-pastel-rose-deep">
      ...
      <header className="w-full py-6 px-8 text-center md:text-left z-30">
        <div className="inline-flex items-center gap-2 select-none">
          <span className="font-script text-3xl text-pastel-rose-deep font-semibold tracking-wide">
            For You
          </span>
      ...
      <main className="w-full max-w-2xl mx-auto px-4 py-8 md:py-16 flex-1 flex flex-col justify-center relative z-20">
        <div className="w-full py-8 px-6 md:p-12 rounded-[40px] bg-white/30 backdrop-blur-md border border-white/50 shadow-xl shadow-pastel-rose-deep/[0.02] flex flex-col items-center justify-center min-h-[500px]">
      ...
      <footer className="w-full text-center py-6 pb-28 text-[10px] font-sans font-medium text-pastel-rose-deep/40 tracking-widest uppercase select-none z-30">
